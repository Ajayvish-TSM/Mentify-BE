    ...
    try {
       ...
       let data = postData;
        ...
        switch (postData.action) {
            case "command":
                userLogger.error(__filename, `Calling command function(callingCommand(data) data = ${JSON.stringify(data, null, 4)}`);
        ...
        res.status(200).json({ "statusCode": 0, "status": "erroe", "message": "faile by generate exception", "data": error.stack });
    }
});
